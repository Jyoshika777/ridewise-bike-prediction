...
def load_model():
    try:
        model = joblib.load("xgb_tuned_model.pkl")  # Path to your saved tuned XGBoost pipeline
        return model
...
st.sidebar.image("[https://cdn-icons-png.flaticon.com/512/3448/3448330.png](https://cdn-icons-png.flaticon.com/512/3448/3448330.png)", width=120)
